...
final class EntityServiceTest extends AbstractIntegrationTestCase
{
    ...
    public function testGetAllTableNames(): void
    {
        ...
        $markdown = $entityService->getAllTableNames();
    ...
    {
        $entityService = self::getService(EntityService::class);
        $result = $entityService->getEntityMetadata('NonExistentEntity');
    ...
    {
        $entityService = self::getService(EntityService::class);
        $result = $entityService->getAllEntitiesMetadata();
    ...
    {
        $entityService = self::getService(EntityService::class);
        $markdown = $entityService->generateDatabaseMarkdown();
